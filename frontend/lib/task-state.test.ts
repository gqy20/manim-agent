...
function buildPipelineOutput(
  ...
  return {
    ...
    render_mode: null,
    segment_render_complete: null,
    timeline_path: null,
    timeline_total_duration_seconds: null,
    segment_render_plan_path: null,
    segment_video_paths: [],
    rendered_segments: [],
    audio_concat_path: null,
    source_code: null,
    audio_path: null,
    bgm_path: null,
    bgm_prompt: null,
    ...
    learning_goal: null,
    audience: null,
    phase1_planning: null,
    phase2_implementation: null,
    phase3_render_review: null,
    phase3_5_narration: null,
    phase4_tts: null,
    phase5_mux: null,
    beats: null,
    audio_segments: [],
    ...
    review_vision_analysis_used: null,
    intro_requested: null,
    outro_requested: null,
    intro_spec: null,
    outro_spec: null,
    intro_video_path: null,
    outro_video_path: null,
    intro_outro_backend: null,
    ...overrides,
  };
}
