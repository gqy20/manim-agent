...
def build_user_prompt(
    ...
    *,
    ...
    guidance = (
        ...
        "- Focus structured_output on implementation facts the agent must author; the pipeline can derive beat-level narration bookkeeping from the approved build spec.\n"
...
def build_output_repair_prompt(
    ...
    *,
    ...
    guidance = (
        ...
        "- Fill in only the missing implementation facts that require agent knowledge from the approved plan and the work you already completed.\n"
        ...
        "- The pipeline can derive beat-to-narration bookkeeping, narration coverage, and estimated narration duration from the approved build spec when needed.\n"
